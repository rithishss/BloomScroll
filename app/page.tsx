          ...
          <div className="mx-auto grid w-full max-w-6xl items-center gap-10 px-4 py-16 sm:py-24 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-5 max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg">
                ...
                source-grounded cards that adapt to what you understand and what needs another look.
              </p>
            ...
            <div className="mt-10 grid gap-6 sm:grid-cols-3">
              {[
                ...
                },
                {
                  step: "02",
                  title: "Bloom",
                  body: "AI distills your material into short cards — concepts, key points, examples, questions, memory hooks — each tied to the exact page it came from.",
                },
                {
                  step: "03",
                  title: "Remember",
                  body: "Swipe through a feed that learns with you. “Got it” schedules spaced reviews; “Review again” brings a card back soon.",
                },
              ].map((item) => (
                <div
                  key={item.step}
          ...
          <div className="mx-auto grid w-full max-w-6xl items-center gap-10 px-4 py-16 sm:py-20 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-4 max-w-lg text-sm leading-relaxed text-muted-foreground sm:text-base">
                ...
                embedded, and searched semantically. Cards and answers are generated strictly from
                retrieved passages — and each one carries a citation to the exact page. Open the
                source drawer on any card to read the original text. When your material doesn&apos;t
                contain an answer, Bloom says so instead of guessing.
              </p>
            </div>
